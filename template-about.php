...
<?php endif; ?>
	<div class="container">
		<div class="tbl">
			<div class="tbl-cell">
				<h1 class="page-title"><?php echo $about_first_screen_title ?></h1>
...
<section class="sec-default">
	<div class="container">
		<p class="sec-header"><?php echo $about_our_story_title ?></p>
		<div class="row fix-1">
		...
		<hr class="about-hr">
		<p class="sec-subheader"><?php echo $about_living_culture_title ?></p>
		<div class="living-culture-bl">
			<div class="row">
				<div class="col-md-6 col-left">
					<div class="tbl">
						<div class="tbl-cell">
							<?php echo $about_living_culture_text ?>
						</div>
					</div>
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/tmp/living-culture-bl-img-1.jpg" alt="">
				</div>
				<div class="col-md-6 col-right">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/tmp/living-culture-bl-img-2.jpg" alt="">
				</div>
			</div>
		</div>
	</div>
...
<section class="sec-default">
	<div class="container">
		<p class="sec-header"><?php echo $about_lgoc_title ?></p>
		<div class="lgoc-bl">
			<?php
			if( $about_lgoc_rows ): ?>
				<?php $cnt = 0; foreach($about_lgoc_rows as $row) : $cnt = $cnt+1; ?>
					...
					<?php if($cnt%2!==0): ?>
						<div class="lgoc-bl-row" style="background-image: url('<?php echo $row['about_lgoc_rows_image'] ?>')">
							<div class="tbl">
