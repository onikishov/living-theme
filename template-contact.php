...
$contact_first_screen_video_file = get_field('contact_first_screen_video_file');
$contact_first_screen_video_bg = get_field('contact_first_screen_video_bg');
...
<?php else: ?>
<section class="sec-top selling" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/images/tmp/about-top-bg-s.jpg')">
<?php endif; ?>
	<?php if(!empty($contact_first_screen_video_file)): ?>
		<video <?php echo (!empty($contact_first_screen_video_bg))?'poster="'.$contact_first_screen_video_bg.'"':'' ?> playsinline autoplay muted loop>
			<source src="<?php echo $contact_first_screen_video_file ?>" type="video/mp4">
		</video>
	<?php endif; ?>
	<div class="container">
		<div class="tbl">
			<div class="tbl-cell">
				<h1 class="page-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.1s"><?php echo $contact_first_screen_title ?></h1>
			</div>
		</div>
	</div>
</section>
	...
	<div class="content-wrap content-wrap-selling">
		...
		if( $contact_our_locations ): ?>
			...
			<section class="sec-default locations whitebg wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.1s">
				<div class="container">
