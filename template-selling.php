...
<?php else: ?>
<section class="sec-top selling" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/images/tmp/selling-top-bg.jpg')">
<?php endif; ?>

	<div class="container">
		<div class="tbl">
			<div class="tbl-cell">
				<h1 class="page-title"><?php echo $selling_first_screen_title ?></h1>
	...
	<div class="container">
		...
		if( $selling_our_services ): ?>
			<?php $cnt = 0; foreach($selling_our_services as $row) : $cnt = $cnt+1; ?>
				...
				<div class="services-row row<?php echo ($cnt%2==0)?' left':'' ?>">
...
<section class="sec-default selling-2">
	<div class="container">
		<p class="sec-header"><?php echo $selling_stories_of_sold_title ?></p>
		<div class="row">
			<?php
			$args = array(
				'post_type' => 'post',
...
<section class="sec-featured with-bg selling fix-2">
	<div class="container">
		<div class="sec-head">
			<p class="sec-header text-center"><?php echo $selling_recent_sales_title ?></p>
	...
	if( $contact_our_locations ): ?>
		...
		<section class="sec-default locations">
			<div class="container">
...
<section class="sec-default locations-bot">
	<div class="container">
		<p class="sec-subheader"><?php echo $selling_title_bottom ?></p>
		<p class="text-center">
